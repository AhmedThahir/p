...
const Plugin = () => {
  ...
  var initialised = false;
	...
	var loaded_styles = []
	var default_theme = document.head.querySelector("#theme")
	if (default_theme != null)
		loaded_styles.push(default_theme.getAttribute("href"))
	var default_highlight_theme = document.head.querySelector("#highlight-theme").getAttribute("href")
	if (default_highlight_theme != null)
		loaded_styles.push(default_highlight_theme.getAttribute("href"))
  ...
  function changeStylesheet(id, href) {
		...
		const current_theme = stylesheet.href

		if (loaded_styles.includes(href)) // this has already been loaded
		{
